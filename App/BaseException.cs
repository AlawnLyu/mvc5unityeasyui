...
namespace App
{
    public class BaseException
    {
        ...
        {
            get { return this.GetExceptionUrl(); }
        }

        public Exception Exception
        {
            get { return (HttpContext.Current.Session["Exception"] as Exception); }
            private set
            {
        ...
        public string ExceptionMessage
        {
            ...
            private set { this.exceptionMessage = value; }
        }

        public string ExceptionName
        {
            get { return this.exceptionName; }
            private set { this.exceptionName = value; }
        }
        ...
        public BaseException()
        {
            ...
            try
            {
                ...
                if (this.Exception != null)
                {
                    ...
                    this.SourceErrorFile = this.GetSourceErrorFile(this.Exception);
                    this.SourceErrorRowID = this.GetSourceErrorRowID(this.Exception);
            ...
            {
                this.ExceptionMessage = "异常基页出错" + ex.Message;
            }
        }
        ...
        private string GetSourceErrorFile(Exception ex)
        {
        ...
        private string GetSourceErrorRowID(Exception ex)
        {
            string stackInfo = this.StackInfo;
            string[] strArray = new string[0];
            if (stackInfo == null)
